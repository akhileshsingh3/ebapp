...
<script src="<c:url value="/resources/mytheme/js/validateRegistration.js"/>"></script> 

<script type="text/javascript"> 
function showSecondForm(){
	document.getElementById("fisrtForm").style.display = 'none';
	document.getElementById("secondForm").style.display = 'inline-block';
	
}
function showFirstForm(){
	document.getElementById("secondForm").style.display = 'none';
	document.getElementById("fisrtForm").style.display = 'inline-block';
	
}
</script>

<title>Elder Brother- Registration</title>
<link rel="stylesheet" href="<c:url value="/resources/mytheme/css/Home3.css" />" type="text/css" media="all" />
<link rel="stylesheet" href="<c:url value="/resources/mytheme/css/homeResize.css" />" type="text/css" media="all" />
<body class="">
<div class="stage stage-bg--1" >
	<header id="header" class="color-span">
	<div class="row"><div class="large-12 columns"><div class="row">
	<a class="right stage-text stage--login" href="LogIn">Already a member? Login Here</a>
	</div></div></div></header>
		...
		<div class="custom-width-for-medium small-12 medium-6 columns margin-bottom-medium-3 no-padding-for-small">
			...
			<form:form  id="signup" action="Registering" method="POST" commandName="registeringuser" class="form-wrap--step1" >
				<div id="fisrtForm" >
					...
					<table>
 					...
 					<tr><td>
 						...
 						<form:errors path="firstname"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div> 
					</td><td>
					<div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left">
					<form:input path="lastname" id="lastname" type="text" name="lastname" placeholder="Last Name"/>
					<form:errors path="lastname" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					</td></tr>
					<tr><td>
					<div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left"> 
					<form:input path="username" id="username" type="email" name="username" placeholder="Email"/>
					<form:errors path="username" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					<td></tr>
					<tr><td>
					<div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left">
					<form:input path="password" id="password" type="password" name="password" placeholder="Password (+6 Characters)"/>
					<form:errors path="password" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					</td></tr>
					<tr><td><div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left">
					<form:input path="currentclass" id="currentclass" type="text" name="currentclass" placeholder="Current Class"/>
					<form:errors path="currentclass" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					</td></tr>
					<tr><td><div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left">
					<form:input path="school" id="school" type="text" name="school" placeholder="School"/>
					<form:errors path="school" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					</td></tr>
					<tr><td><div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left">
					<form:input path="affiliation" id="affiliation" type="text" name="affiliation" placeholder="Board"/>
					<form:errors path="affiliation" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					</td></tr>
					<tr><td><div class="small-12 columns collapse input-wrap input-wrap-icon input-wrap-icon--left">
					<form:input path="city" id="city" type="text" name="city" placeholder="City"/>
					<form:errors path="city" element="div"/><div class="errorTxt"></div><div class="icon-">&#9656;</div></div>
					</td></tr>
				...
				<div class="button-wrap button--blue">
					...
					<%-- <div class="button-wrap button--blue">
					<input type="button" class="button" value="Next" onclick="showSecondForm()"/>
					</div>
				</div>
				...
				<div id="secondForm" style="display: none">
					...
					<table><tr>
						<td><div class="button-wrap button--blue">
							<input type="button" class="button " value="<<Back" onclick="showFirstForm()"/>
						</div></td>
						<td>
						<div class="button-wrap button--blue">
							<input type="submit" class="button" name="action" value="Submit"/>
